...
const DistrictList = () => {
    ...
    const loadLazyData = async () => {
        ...
        let result = await districtService.filterPage(advanceSearch);
        ...
        return (
            <React.Fragment>
                <div className='flex flex-row justify-content-end' >
                    <Link to={'/admin/district-form/' + rowData.id}><i className="p-button-rounded p-button p-button-text p-1 pi pi-pencil mr-2 flex align-items-center"></i></Link>
    ...
    return (
        <Card title="Danh mục Quận/huyện">
            <div className='row mb-2'>
                <div className="col-4 col-sm-8">
                    <Link to={'/admin/district-form/new'}>
