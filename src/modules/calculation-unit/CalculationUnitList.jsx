...
const CalculationUnitList = () => {
    ...
    const loadLazyData = async () => {
        ...
        let result = await calculationUnitService.filterPage(advanceSearch);
        ...
        return (
            <React.Fragment>
                <div className='flex flex-row justify-content-end' >
                    <Link to={'/admin/calculation-unit-form/' + rowData.id}><i className="p-button-rounded p-button p-button-text p-1 pi pi-pencil mr-2 flex align-items-center"></i></Link>
    ...
    const deleteItem = async (id) => {
        await calculationUnitService.delete(id);
        loadLazyData();
    }
    ...
    return (
        <Card title="Danh mục đơn vị tính">
            <div className='row mb-2'>
                <div className="col-4 col-sm-8">
                    <Link to={'/admin/calculation-unit-form/new'}>
...
export default CalculationUnitList;