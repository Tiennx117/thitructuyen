...
const StoreList = () => {
    ...
    const loadLazyData = async () => {
        ...
        let result = await storeService.filterPage(advanceSearch);
        ...
        return (
            <React.Fragment>
                <div className='flex flex-row justify-content-end' >
                    <Link to={'/admin/store-form/' + rowData.id}><i className="p-button-rounded p-button p-button-text p-1 pi pi-pencil mr-2 flex align-items-center"></i></Link>
    ...
    return (
        <Card title="Danh sách cửa hàng">
            ...
            >
                ...
                <Column field="address" sortable header="Địa chỉ" />
