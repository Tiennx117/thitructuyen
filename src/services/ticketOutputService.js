...
let path = '/api/ticketoutput'
const ticketOutputService = {
    create(obj){
    ...
    getAll(){
        ...
        return axios.patch(path + '/done?ticket_id='+ticket_id);
    },
    cancel(ticket_id){
        return axios.patch(path + '/cancel?ticket_id='+ticket_id);
    },
    saveAndDone(obj){
        return axios.put(path + '/saveAndDone', obj);
    },
...
export { ticketOutputService as default, ticketOutputService };
