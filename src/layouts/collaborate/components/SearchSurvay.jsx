    ...
    return (
        <>
            <div className="input-group-append search-box" style={{ width: '40%', borderRadius: '5px'}}>
                ...
                <label style={{ borderLeft: 'none', marginLeft:"-4px", height:"33.5px" }} className="input-group-text" onClick={searchfile} type="button" htmlFor="inputGroupSelect02" id="button-addon01"><FaSearch /></label>
            </div>
        </>
    )
}
