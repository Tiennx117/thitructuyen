...
const Post = (props) => {
    ...
    return (
        <>
            {/* {console.log('shareTree', props.shareTree)} */}
            <div >
                <div className="card" >
                                ...
                                <div className='col-12 col-lg-9'>
                                    <Card title="CHIA SẺ VỚI" >
                                        <div className='card-header' onChange={event => onChangeValue(event.target.value)}>
                                            ...
                                            <input type="radio" id='option2' defaultValue={1} name="content" style={{ marginLeft: '15px' }}
                                                onClick={() => CheckUserDetail()} />
                                            ...
                                            {checkShareAll == false ?
                                                <Card>
                                                    <div className='card-all-user'>
                                                        ...
                                                        <div>
                                                            <h5>{getFileImg.FileLabel} hình ảnh</h5>
                                                            <div className="mb-3">
                                                        ...
                                                        <div>
                                                            <h5>{getFile.FileLabel} tệp đính kèm</h5>
                                                            <div className="mb-3">
                                                                <input accept="doc, docx, xls, xlsx, ppt, pptx, txt, pdf " name='AttachmentFilePath' className="form-control" type="file" onChange={onChangeFile} />
                                                            </div>
                                                            <div style={{ backgroundColor: "#3333", marginTop: "6px", height: "20px", width: "100%" }}></div>
                                                            <div>Ghi chú: </div>
                                                            <div>-Kích thước tệp tối đa tải lên là {getFile.AllowFileSize} MB</div>
                                                            <div>-Các định dạng tệp được phép là:</div>
                                                            <div dangerouslySetInnerHTML={{ __html: getFile.AllowedDisplayFileTypes }}></div>
                                                        </div>
